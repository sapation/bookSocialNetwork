...
import { returnedBorrowBook } from '../fn/book/returned-borrow-book';
import { ReturnedBorrowBook$Params } from '../fn/book/returned-borrow-book';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `returnedBorrowBook()` */
  static readonly ReturnedBorrowBookPath = '/books/borrow/returned/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `returnedBorrowBook()` instead.
   *
   * This method doesn't expect any request body.
   */
  returnedBorrowBook$Response(params: ReturnedBorrowBook$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return returnedBorrowBook(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `returnedBorrowBook$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  returnedBorrowBook(params: ReturnedBorrowBook$Params, context?: HttpContext): Observable<number> {
    return this.returnedBorrowBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
